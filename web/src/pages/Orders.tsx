    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-2 text-[var(--color-muted)]">
          Objednávky, fulfillment, tracking a profit na úrovni objednávky.
        </p>
      </header>
      <section className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)]/90 p-6">
        <h2 className="text-lg font-semibold">ORDER_LEVEL</h2>
        <p className="mt-1 text-sm text-[var(--color-muted)]">
          Najnovšie riadky bez preklikávania v Google Sheets.
        </p>
        <div className="mt-5">
          <DataTable
            rows={rows}
